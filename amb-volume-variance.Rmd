...
holidays <- paste(names(holidaysBetween(as.Date(start_date), as.Date(end_date), goodFriday = F, board = F, inaug = F, businessOnly = T)),collapse=", ")
...
```
<span style='font-size: 14px; font-style: italic; color: black'>*Data excludes `r holidays`</span><br/>
